        ...
        const fetchLiveRecipes = async () => {
            try {
                ...
                const response = await fetch(
                    `${process.env.NEXT_PUBLIC_SERVER_URL}/recipes?search=${searchQuery}&category=${selectedCategory}`
                );
                                        ...
                                        <div className="p-5 flex flex-col flex-grow justify-between">
                                            <div>
                                                <div className="flex items-center gap-3 text-xs opacity-60 mb-2 font-medium">
                                                    <span className="flex items-center gap-1"><FaClock className="text-[10px]" /> {recipe.cookingTime}</span>
                                                    <span className="flex items-center gap-1 text-amber-500"><FaStar className="text-[10px]" /> {recipe.ratings}</span>
                                                </div>
